...
const Dashboard = () => {
  ...
  return (
    <div className="space-y-6">
      <div>
        <h1 className="text-4xl font-bold text-gray-900">Welcome to Natural Farm Sira</h1>
        <p className="text-gray-600 mt-2">You're all set to manage your farm operations</p>
      </div>
