...
import { Phone, MapPin, MessageCircle, Instagram, Facebook, Mail, Clock, ArrowRight, Youtube } from 'lucide-react';
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-10">
          ...
          <div className="lg:col-span-1">
            ...
            <div className="flex gap-3">
              ...
              <a href="https://wa.me/918660674360" target="_blank" rel="noopener noreferrer" className="w-10 h-10 rounded-xl bg-whatsapp flex items-center justify-center hover:bg-whatsapp/80 transition-all hover:scale-110">
